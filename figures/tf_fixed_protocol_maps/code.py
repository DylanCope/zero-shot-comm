...
def reproduce_figure():
    data = [
        ...
        for csv_path in Path("figures/tf_fixed_protocol_maps").glob("data_*.csv")
    ]
    plot_tf_fixed_protocol_maps(*data)
    plt.savefig(
        "figures/tf_fixed_protocol_maps/tf_fixed_protocol_maps.pdf",
        bbox_inches="tight",
        dpi=1000,
    )
